          ...
          <Accordion disabled={assetTxCount === 0} compact style={{ maxWidth: 1400 }}>
            <AccordionSummary>
              ...
              >
                ...
                <div style={{ flex: 4 }}>
                  <Text size="lg" strong>
                    {`${transferContent.length > 0 ? transferContent.length : "no"} transfer${
                      transferContent.length > 1 || assetTxCount === 0 ? "s" : ""
                    }`}
                  </Text>
                </div>
              </div>
            ...
            <AccordionDetails>
              <AssetTransferTable transferContent={transferContent} />
            </AccordionDetails>
          </Accordion>
        ))}
